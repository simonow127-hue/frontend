      ...
      <div className="max-w-2xl mx-auto text-right">
        ...
        <div className="flex flex-col gap-6 text-brand-espresso/80 text-sm leading-loose">
          <section>
            ...
            <p>باستخدام موقع riads.shop وتقديم طلب، فأنت توافق على هذه الشروط.</p>
          </section>
          <section>
            <h2 className="font-bold text-base text-brand-espresso mb-2">الطلبات</h2>
            <p>كل طلب يخضع للتأكيد الهاتفي. رياض تحتفظ بحق رفض أي طلب غير مؤكد أو مكرر.</p>
          </section>
          <section>
            <h2 className="font-bold text-base text-brand-espresso mb-2">المنتجات</h2>
            <p>المنتجات موصوفة بدقة ضمن حدود ما هو مسموح به. لا نقدم ادعاءات طبية مضمونة.</p>
          </section>
          <section>
            <h2 className="font-bold text-base text-brand-espresso mb-2">الأسعار</h2>
            <p>الأسعار قابلة للتغيير. السعر المعروض عند الطلب هو السعر المعتمد.</p>
          </section>
          <section>
            <h2 className="font-bold text-base text-brand-espresso mb-2">الملكية الفكرية</h2>
            <p>جميع محتويات الموقع من نصوص وصور وشعارات هي ملكية حصرية لـ رياض (riads.shop).</p>
          </section>
        </div>
      </div>
    </div>
