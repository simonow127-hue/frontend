...
function productImages(id: string) {
  return {
    pain: "/images/products/section-pain.svg",
    science: "/images/products/section-science.svg",
    ingredients: "/images/products/section-ingredients.svg",
    usage: "/images/products/section-usage.svg",
  };
}
